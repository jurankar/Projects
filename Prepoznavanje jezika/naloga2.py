...
class Kmedoids:
    ...
    def run(self):
        ...
        print("Najbolj verjetni jezik je " + top3jeziki[0][0] + " z verjetnostjo " + str(top3jeziki[0][1] * 100) + "%\n")
        print("Drugi najbolj verjetni jezik je " + top3jeziki[1][0] + " z verjetnostjo " + str(top3jeziki[1][1] * 100) + "%\n")
        print("Tretji najbolj verjetni jezik je " + top3jeziki[2][0] + " z verjetnostjo " + str(top3jeziki[2][1] * 100) + "%\n")
